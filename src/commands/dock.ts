...
/**
 * Airplay Album Name Info (Airplay Model Only) (AAL)
 */
...
/**
 * Airplay Artist Name Info (Airplay Model Only) (AAT)
 */
...
/**
 * Airplay Play Status (Airplay Model Only) (AST)
 */
...
/**
 * Airplay Title Name (Airplay Model Only) (ATI)
 */
...
/**
 * Airplay Time Info (Airplay Model Only) (ATM)
 */
...
/**
 * Bluetooth(Internal) Operation Command (NBT)
 */
...
/**
 * NET/USB Jacket Art (When Jacket Art is available and Output for Network Control Only) (NJA)
 */
...
/**
 * NET Keyboard(for Network Control Only) (NKY)
 */
...
/**
 * NET/USB List Info(All item, need processing XML data, for Network Control Only) (NLA)
 */
...
/**
 * NET/USB List Title Info(for Network Control Only) (NLT)
 */
...
/**
 * NET/USB List Info (Update item, need processing XML data, for Network Control Only) (NLU)
 */
...
/**
 * iPod Mode Change (with USB Connection Only) (NMD)
 */
...
/**
 * Internet Radio Preset Command (NPR)
 */
...
/**
 * NET Popup Message(for Network Control Only) (NPU)
 */
...
/**
 * Receiver Information (for Network Control Only) (NRI)
 */
...
/**
 * Network Standby Settings (for Network Control Only and Available in AVR is PowerOn) (NSB)
 */
...
/**
 * NET Service(for Network Control Only) (NSV)
 */
...
/**
 * Network/USB Operation Command (Network Model Only after TX-NR905) (NTC)
 */
